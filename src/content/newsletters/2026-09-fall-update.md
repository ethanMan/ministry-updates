...
The school year started three weeks ago, which means our weekday afternoons are full
again with tutoring. We are averaging about 25 students a day, up from 18 last year. It
is more than we planned for, which is a good problem to have.

## How you can pray

- For the students in our afternoon tutoring program, especially the handful who are
  behind in reading
- For wisdom as we decide whether to add a second tutoring location in the spring
- For rest — it was a long summer, and we are feeling it
